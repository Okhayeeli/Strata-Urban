...
//
//    @Column
//    private String providerName; // Name of the supplier providing the vehicles
//
//    @Column
//    private BigDecimal providerRating; // Supplier's rating, if available (e.g., 4.5 out of 5)
//
//    @Column
